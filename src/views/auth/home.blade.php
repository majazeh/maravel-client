...
@endif
<div class="mb-4">
    <input type="text" class="w-full text-sm text-left dir-ltr border border-gray-200 rounded-sm" id="authorized_key" name="authorized_key" value="{{ app('request')->authorized_key }}" placeholder="{{ auth()->check() ? __('Entry Command') : __('Phone, Email or Username') }}">
</div>
